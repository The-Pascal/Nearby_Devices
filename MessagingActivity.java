...
public class MessagingActivity extends AppCompatActivity {
    ...
    private final String SERVICE_ID = "com.example";
                            ...
                            .addOnSuccessListener(
                                    new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unusedResult) {
                                            ...
                                            Toast.makeText(MessagingActivity.this, "Requested Discovery", Toast.LENGTH_SHORT).show();
                                        }
                                    })
    ...
    private final PayloadCallback mPayloadCallback = new PayloadCallback() {
        ...
        public void onPayloadReceived(String endpointId, Payload payload) {
            ...
            ArrayList<String> tempEndpoints = new ArrayList<>(endpoints);
            Log.i(TAG, "onPayloadReceived: " + endpoints.toString());
            for (int i = 0; i < tempEndpoints.size(); i++) {
                if(tempEndpoints.get(i).equals(endpointId)) {
                    tempEndpoints.remove(i);
                }
            }
            Log.i(TAG, "onPayloadReceived: " + tempEndpoints.toString());
            if (mMessageAdapter.add(msg)) {
                //forward message onward here if it was a new message for you.
                Nearby.getConnectionsClient(MessagingActivity.this).sendPayload(tempEndpoints,
                ...
                public void onConnectionResult(String endpointId, ConnectionResolution result) {
                    switch (result.getStatus().getStatusCode()) {
                        case ConnectionsStatusCodes.STATUS_OK:
                            ...
                            Toast.makeText(MessagingActivity.this, "Successfully connected", Toast.LENGTH_SHORT).show();
    ...
    void finishSetup(){
        ...
        if (ContextCompat.checkSelfPermission(MessagingActivity.this, Manifest.permission.WRITE_CALENDAR)
            ...
            ActivityCompat.requestPermissions(MessagingActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},
                    1);
        } else {
            goodPerms = true;
        }
    ...
    private void startAdvertising() {
        Log.d(TAG, "startAdvertising: START ADVERTISING SHOULD HAPPEN");
